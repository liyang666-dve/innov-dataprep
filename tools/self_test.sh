...
echo "== 2/9 03 清洗：脏集应全排除(5)，干净集应全保留(5) =="
...
echo "== 9/9 06 转换预检（--check 不依赖官方转换器，dev 可跑） =="
